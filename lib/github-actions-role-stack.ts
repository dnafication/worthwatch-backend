...
export class GithubActionsRoleStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: GithubActionsRoleStackProps) {
    ...
    this.role = new iam.Role(this, 'GithubActionsDeployRole', {
      ...
      description: 'Role assumed by GitHub Actions for CDK deployments via OIDC',
    ...
    new cdk.CfnOutput(this, 'GitHubActionsRoleArn', {
      ...
      description: 'IAM role ARN for GitHub Actions OIDC authentication. Configure this in GitHub repository secrets as AWS_ROLE_ARN.',
